...
if ! [[ -f 'ServerFiles-2.44.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'ServerFiles-2.44.zip' 'https://mediafilez.forgecdn.net/files/6427/314/ServerFiles-2.44.zip' || exit 9
	unzip -u -o 'ServerFiles-2.44.zip' -d /data
